...
HBRUSH keyboard_ctrl_brush_BACKCOLOR = CreateSolidBrush(RGB(50, 50, 50));
HBRUSH keyboard_ctrl_brush_UNUSED_TRIM = CreateSolidBrush(RGB(130, 130, 130));
HBRUSH keyboard_ctrl_brush_UNUSED_TOP = CreateSolidBrush(RGB(125, 125, 125));
HBRUSH keyboard_ctrl_brush_UNUSED_BOTTOM = CreateSolidBrush(RGB(125, 125, 125));

HBRUSH keyboard_ctrl_brush_ACTIVE_TRIM = CreateSolidBrush(RGB(200, 200, 200));
HBRUSH keyboard_ctrl_brush_ACTIVE_TOP = CreateSolidBrush(RGB(74, 106, 25));
HBRUSH keyboard_ctrl_brush_ACTIVE_BOTTOM = CreateSolidBrush(RGB(65, 85, 15));

HBRUSH keyboard_ctrl_brush_INACTIVE_TRIM = CreateSolidBrush(RGB(100, 100, 100));
HBRUSH keyboard_ctrl_brush_INACTIVE_TOP = CreateSolidBrush(RGB(30, 30, 30));
HBRUSH keyboard_ctrl_brush_INACTIVE_BOTTOM = CreateSolidBrush(RGB(15, 15, 15));
...
void keyboard_ctrl_paint(HDC hdc) {
	...
	for (int i = 0; keyboard_ctrl_keys[i] != 0; i++) {
		for (int j = 0; keyboard_ctrl_keys[i][j] != 0; j++) {
			...
			DrawText(hdc, text, strlen(text), &r, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
